...
<div class="container">
	<div class="row">
		...
		<div class="col-12 mt50 make-an-appointment">
			<div class="appointment-form-content">
				<div class="row no-gutters align-items-center">
					<div class="col-12">
						<div class="medilife-appointment-form">
							<h3 class="appoint-head">Make an Appointment</h3>
							<!--<h3>Make an Appointment</h3>-->
							<form action="#" method="post" class="appoint-form">
								<div class="row align-items-end">
									...
									<div class="col-12 col-md-12">
										<div class="form-group mb-0">
											<textarea name="message" class="form-control mb-0 border-top-0 border-right-0 border-left-0" id="message" cols="30" rows="10" placeholder="Message" tabindex="1" style="overflow: hidden; outline: none;"></textarea>
										</div>
									</div>
									<div class="col-12 col-md-12 neon-wrap">
										<div class="form-group">
											<button type="submit" class="btn neon-btn">Make an Appointment</button>
										</div>
									</div>
								</div>
							</form>
...
<div class="about-main" id="about-us">
	<div class="about-wrap">
		<h3 class="about-head">About Us</h3>
		<p>
			Neon Hospital, incorporated in feb 2018 is in Dombivli, Thane. The vision here is to pioneer cost-effective,
			personalized and high quality healthcare for our patients across the domains of multi-speciality DayCare,
			Emergency Medicine & Acute Care By Medical professionals. The inclusion of Complementary & Alternative
			Medicine in our service segments is our next goal.
		</p>
		<div class="about-carousal-wrap">
			<div class="owl-carousel owl-theme about-carousal">
				<div class="item"> <img src="assets/images/about-banner/about1.jpg" class="img-responsive" alt="">

				</div>
				<div class="item"> <img src="assets/images/about-banner/about2.jpg" class="img-responsive" alt="">

				</div>
				<div class="item"> <img src="assets/images/about-banner/about3.jpg" class="img-responsive" alt="">
